                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Save Item</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Save Item</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
...
<!-- basic form  -->
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h1 class="card-header">Save Item</h1>
                                    <div class="card-body">
        ...
        <asp:Label ID="Label1" runat="server" class="col-form-label" ForeColor="#04046f" style="height: 50px; width : 500px" Text="Category"></asp:Label>
        &nbsp;
        <asp:DropDownList ID="CategoryDropDownList" class="form-control" ForeColor="#04046f" style="height: 50px; width : 500px" runat="server">
        </asp:DropDownList>
        <br />
        
        <asp:Label ID="Label2" runat="server" ForeColor="#04046f" style="height: 50px; width : 500px" Text="Company"></asp:Label>
        <asp:DropDownList ID="CompanyDropDownList" class="form-control" ForeColor="#04046f" style="height: 50px; width : 500px" runat="server">
        </asp:DropDownList>
        <br />
        
        <asp:Label ID="Label3" runat="server" ForeColor="#04046f" style="height: 50px; width : 500px" Text="Item Name"></asp:Label>
        <asp:TextBox ID="ItemNameTextBox" class="form-control" ForeColor="#04046f" style="height: 50px; width : 500px" runat="server"></asp:TextBox>
        <br />

       <asp:Label ID="Label4" runat="server" ForeColor="#04046f" style="height: 50px; width : 500px" Text="Reorder Level"></asp:Label>
     
        <asp:TextBox ID="ReorderLevelTextBox" class="form-control" runat="server" ForeColor="#04046f" style="height: 50px; width : 500px"></asp:TextBox>
        <br />
         <asp:Label ID="errorMessegeLabel" runat="server" Text="" ForeColor="red"></asp:Label>
        <br />
        
        
        <asp:Button ID="saveButton" runat="server" class="btn btn-primary" style="height: 50px; width : 100px" OnClick="saveButton_Click1" Text="Save" />
        
        <br />
        <asp:Label ID="messageLevel" runat="server"></asp:Label>
