<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryUI.aspx.cs" Inherits="StockManagementWebApp.UI.SummaryUI" %>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title">Summary</h1>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" class="categorySaveForm" runat="server">
                                        ...
                                        <br />
                                        <asp:Label ID="Label1" runat="server" ForeColor="#04046f" Text="Category" Font-Size="20px" Style="height: 50px;"></asp:Label>

                                        <asp:DropDownList ID="CategoryDropDownList" class="form-control" ForeColor="#04046f" Font-Size="20px" Style="height: 50px; width: 800px" runat="server">
                                        </asp:DropDownList>
                                        <br />
                                        <br />
                                        <asp:Label ID="Label2" runat="server" ForeColor="#04046f" Font-Size="20px" Text="Company"></asp:Label>
                                        <asp:DropDownList ID="CompanyDropDownList" class="form-control" Font-Size="20px" ForeColor="#04046f" Style="height: 50px; width: 800px" runat="server">
                                        </asp:DropDownList>
                                        <br />
                                     
                                        <asp:Label ID="errorMessegeLabel" runat="server" Text="" ForeColor="red"></asp:Label>
                                        <br />
                                        <asp:Button ID="searchButton" class="btn btn-primary" runat="server" OnClick="searchButton_Click" BackColor="#007bff" ForeColor="White" Text="Search " />
                                        <br /> <br />

                                        <asp:GridView ID="summaryGridView" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="AvailableQuantity" HeaderStyle-Width="300px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="ItemQuantity" runat="server" Text='<%#Eval("AvailableQuantity")%>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="ReorderLevel" HeaderStyle-Width="300px">
                                                    <ItemTemplate>
                                        ...
                                        <br />
                                        <asp:Label ID="messageLevel" ForeColor="Red" Font-Size="20px"  runat="server"></asp:Label>
