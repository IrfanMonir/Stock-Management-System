                                ...
                                <div class="card-body">
                                    <form method="POST" class="categorySaveForm" runat="server">
                                        <div class="form-group">
                                            <label for="categoryTextBox" style="font-size: x-large">Enter Category Name</label>
                                        ...
                                        <asp:GridView ID="categoryGridView" HorizontalAlign="Center" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="updateLinkButton" runat="server" ForeColor="blue" OnClick="updateLinkButton_OnClick">Update</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
